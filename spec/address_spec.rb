...
describe(Address) do
  ...
  describe('#street') do
    it('returns street address from the full address') do
      address1 = Address.new({:street => "828 NE 69th Ave", :city => "Portland", :state => "Oregon", :zip => 97213, :type => "home"})
  ...
  describe('.find') do
    it('returns the address that matches the id in the address array') do
      address1 = Address.new({:street => "828 NE 69th Ave", :city => "Portland", :state => "Oregon", :zip => 97213, :type => "home"})
      address1.save()
      address2 = Address.new({:street => "9019 SW Broadleaf Dr", :city => "Portland", :state => "Oregon", :zip => 97219, :type => "home"})
      address2.save()
